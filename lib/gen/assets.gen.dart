...
class $AssetsPngsGen {
  ...
  /// File path: assets/pngs/specimen.png
  AssetGenImage get specimen => const AssetGenImage('assets/pngs/specimen.png');
...
class $AssetsSvgsGen {
  ...
  /// File path: assets/svgs/support_us.svg
  String get supportUs => 'assets/svgs/support_us.svg';

  /// List of all assets
  List<String> get values => [backButton, google, supportUs];
}
